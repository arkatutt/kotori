...
const fs = require('fs')
//~~~~~~~~~SETTING BOT~~~~~~~~~~//
global.owner = "628" //ganti aja
global.nama = "ʏᴀꜱꜱxᴏꜰᴄ" //ganti aja
global.namaowner = "ʏᴀꜱꜱxᴏꜰᴄ" // Ganti aja
global.namaBot = "ᴋᴏᴛᴏʀɪ ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ" // Ganti aja
global.ch = 'https://whatsapp.com/channel/' // Ganti aja
global.ownername = "ʏᴀꜱꜱxᴏꜰᴄ" // Ganti aja
global.botname = "ᴋᴏᴛᴏʀɪ ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ" // Ganti aja
global.status = true 
global.foother = "©ᴋᴏᴛᴏʀɪ" // Ganti aja
global.namach = 'ᴋᴏᴛᴏʀɪ ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ' // Ganti aja
global.idch = '120363302865191524@newsletter' // diemin kalau gda
global.namafile = 'ʏᴀꜱꜱxᴏꜰᴄ' // Ganti aja
global.yt = 'https://youtube.com/@yassxofc' // Ganti aja
global.themeemoji = '🌸' // Ganti aja
global.packname = "sᴛɪᴄᴋᴇʀ ʙʏ" // Ganti aja
global.author = "\n\n\n\n\nᴄʀᴇᴀᴛᴇ ʙʏ ᴋᴏᴛᴏʀɪ\nʏᴛ : ʏᴀꜱꜱxᴏꜰᴄ" // Ganti aja
global.creator = "6285179836603@s.whatsapp.net" // Ganti aja
...
global.qris = "https://files.catbox.moe/y0dmtp.jpg" // Ganti aja
//====== [ THEME URL & URL ] ========//
global.thumb = fs.readFileSync('./kotori.jpg'); // Buffer Image
global.thumbfurina = 'https://files.catbox.moe/y0dmtp.jpg'
global.thumbnail = 'https://files.catbox.moe/y0dmtp.jpg' // Ganti aja
global.reply = 'https://files.catbox.moe/y0dmtp.jpg' // Ganti aja
global.Url = '-' //
...
global.packname = 'ᴋᴏᴛᴏʀɪ' // Ganti aja
